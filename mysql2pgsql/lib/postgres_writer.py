    ...
    def column_type_info(self, column):
        ...
        def get_type(column):
            ...
            if column['type'] == 'char':
                ...
                default = (" DEFAULT %s" % ('true' if "b'0'" != column['default'] and int(column['default']) == 1 else 'false')) if t(default) else None
            ...
            elif column['type'] in ('blob', 'tinyblob', 'mediumblob', 'longblob', 'binary', 'varbinary'):
